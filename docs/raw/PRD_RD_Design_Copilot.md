...
│  │                     核心流程引擎                             ││
│  │  ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌─────────┐          ││
│  │  │ Phase 1 │→│ Phase 2 │→│ Phase 3 │→│ 沉澱    │          ││
│  │  │ Define  │ │ Diverge │ │ Converge│ │ 資產    │          ││
│  │  └─────────┘ └─────────┘ └─────────┘ └─────────┘          ││
│  └─────────────────────────────────────────────────────────────┘│
│                              ↑                                   │
│  ┌─────────────────────────────────────────────────────────────┐│
...
| **F2.6** | Phase Gate 2 檢查 | P0 | 驗證至少 3 條架構級路線通過 MUST |
...
| **M2: Phase 1 功能** | Week 3-6 | 任務定義、索克拉底、矛盾識別 |
| **M3: Phase 2 功能** | Week 7-10 | 假設台帳、TRIZ、SCAMPER、方案集合 |
| **M4: Phase 3 功能** | Week 11-14 | KT 決策、風險、最小實驗 |
